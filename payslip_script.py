...
#Payslip variables
company_name = 'Area 27 Pvt Ltd'
#date and time
last_month = datetime.now() - relativedelta(months=1)

# Create string of month name and year...
d2 = format(last_month, '%B %Y')
...
def create_payslip():
    for i in range (2, 42):
        ...
        c = canvas.Canvas(str(emp_name)+'_'+str(emp_last_name)+'_'+str(emp_id) + '_' +str(d2) + '.pdf' )
        ...
        text = 'Salary calculation for period ' +str(d2) 
        ...
        c.drawString(start_2, y,'This is a System Generated File ')
    
        #Saving the pdf file
        c.save()

def merge_pdfs():
    files_dir = 'C:\\Users\\Administrator\\Desktop\\Payslips-with-python-master\\generate payslip' #Select the directory where the pdf files are located
